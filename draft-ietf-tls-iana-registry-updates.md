...
- Add a "Recommended" column with the contents as listed below.  This
  ...
  REQUIRED to register an extension with the value "Yes".  IESG action
...
- Add a "Recommended" column to the TLS Cipher Suite registry.  The
  ...
  value “Yes”.   IESG action is REQUIRED for a Yes->No transition.
...
register an extension with the value "Yes".   IESG action is REQUIRED
for a Yes->No transition.
...
entry with the value "Yes".   IESG action is REQUIRED for a
Yes->No transition.
